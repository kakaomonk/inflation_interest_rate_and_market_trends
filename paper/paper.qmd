...
The raw data sets were cleaned with R[@citeR], Tidyverse[@citeTidyverse], Lubridate[@citeLubridate]. Since the inflation rate and interest rate do not change everyday, the NASDAQ index price and Bitcoin price need to be analyzed in quarterly data. The  

## Variables in interest

The study focuses on the correlation between the inflation rate and the interest rate in Canada, and how they impact on the stock market and cryptocurrency price. The interest variables in this study
