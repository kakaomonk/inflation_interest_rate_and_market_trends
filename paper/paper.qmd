...
cleaned_inflation = read_csv(here("data/analysis_data/cleaned_inflation.csv"))
cleaned_interest = read_csv(here("data/analysis_data/cleaned_interest.csv"))
cleaned_nas = read_csv(here("data/analysis_data/cleaned_nas.csv"))
cleaned_btc = read_csv(here("data/analysis_data/cleaned_btc.csv"))
```
...
The study focuses on the correlation between the inflation rate and the interest rate in Canada, and how they impact on the stock market and cryptocurrency price. The interest variables in this study are 'CPI inflation rate', 'interest rate', 'NASDAQ index close price', and 'Bitcoin close price'. 
...
kable(cleaned_inflation)
kable(cleaned_interest)
kable(cleaned_nas)
kable(cleaned_btc)
```
...
```{r}
#| label: Summary of each variable
